...
get_franchise_json <- fromJSON(get_franshise_text, flatten=TRUE)
get_franchise_df <- as.data.frame(get_franshise_json)
print(get_franchise_df)
...
team2 <- "1" #Insert Team Common name or ID here 
...
```{r Contingency 2, include=TRUE}
secondctable <- table(get_fgr_df$data.activePlayer, get_fgr_df$CareerWP500)
